    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
        <ServiceCard
          ...
          El parto planificado en domicilio, con atención o compañía profesional, es una forma de nacer maravillosa, segura respaldada a nivel mundial.
          ...
          Actualmente además estoy siendo acompañada en los partos por dos doulas de aquí de Chillán por lo que el ambiente tanto físico, como emocional y espiritual, están resguardados. Dando de esta forma una atención integral a las necesidades de cada familia.
          "
          img={imgService01}
        />
        ...
        <ServiceCard
          ...
          body="Debido a la situación en el mundo actualmente, me vi en la obligación de cambiar el modo de atender, de tal forma que me resultara cómodo ser madre y además trabajar y darle el espacio a tus preguntas y necesidades. Entonces surgio la modalidad en línea.
          La consulta en línea se realiza a través de Internet por una videollamada de WhatsApp, dura en promedio 45 minutos.
        ...
        <ServiceCard
          ...
          body="Antes del brote Covid ya eran necesarias las consultas en domicilio. Hoy más aún, las madres no queremos ponernos en riesgo y tampoco a nuestros hijos. Muchas mujeres además tienen a su cuidado hijos pequeños o adultos mayores lo que dificulta enormemente la movilización fuera del hogar.
